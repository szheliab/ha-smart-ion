...
This repository has two independent deliverables:

## Project structure

```
ha-smart-ion/
├── custom_components/smart_ion/  # HACS-installable custom integration
...
`smart-ion-query` CLI) or as a dependency of the custom integration above.
