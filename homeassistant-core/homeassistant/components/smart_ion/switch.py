...
async def async_setup_entry(
    ...
    async_add_entities(
        SmartIonSwitch(entry.runtime_data, description) for description in DESCRIPTIONS
    )
...
class SmartIonSwitch(SmartIonEntity, SwitchEntity):
    ...
    def __init__(
        ...
        description: SmartIonSwitchDescription,
    ) -> None:
